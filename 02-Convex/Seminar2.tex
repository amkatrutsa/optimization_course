...
Пусть $x_1, \ldots, x_k \in G$, тогда точка $\theta_1 x_1 + \ldots + \theta_k x_k$ при {\color{red}{$\sum\limits_{i=1}^k \theta_i = 1$}} называется аффинной комбинацией точек $x_1,\ldots,x_k$.
\end{block}
...
\item Образ перспективного отображения
\[
